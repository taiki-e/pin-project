...
//
// Note: If the proc-macro does not depend on its own items, it may be
// preferable not to support overwriting the name of core/std crate for
// compatibility with reexport.
