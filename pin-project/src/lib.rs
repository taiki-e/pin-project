...
//
// We now have that looks like this:
//
...
// This will cause rust to conservatible assume that 'Wrapper<MyStruct<T>>: UnsafeUnpinned'
// holds, in the interest of preserving fowrads compatibility (in case such an impl is added
...
//
// This acheives the desired effect - when `#[pin_projectable(unsafe_Unpin)]`,
